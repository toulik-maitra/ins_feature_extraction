<<<<<<< HEAD
# INS Spectrum ML Analysis System
...
@software{ins_ml_analysis_system,
  title={INS Spectrum ML Analysis System},
  author={Your Name},
  year={2024},
  url={https://github.com/yourusername/ins-ml-analysis-system}
}
```
...
>>>>>>> 2f9ba24827e1107e4537f56968535093aea36fcb
